    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          {/* Google Login */}
          <div className="mb-6">
            <button className="flex items-center justify-center w-full bg-white text-black py-2 rounded-md hover:bg-gray-200 transition">
          ...
          <form>
            ...
            <button
              type="submit"
              className="w-full bg-[#DCC7AA] text-[#3C2F2F] py-2 rounded-md font-semibold hover:bg-[#C7B08F] transition"
            >
              Log In
            </button>
          </form>
          ...
          <p className="text-center text-sm text-[#F7F4F1]/70 mt-4">
            ...
            <a href="/register" className="text-[#DCC7AA] hover:underline">
              Sign up
            </a>
          </p>
        </motion.div>
